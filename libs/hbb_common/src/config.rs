...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new(include_str!("app_name").to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &[include_str!("relay_server")];
pub const PUBLIC_RS_PUB_KEY: &str = include_str!("pb_key");
...
impl Config {
    ...
    pub fn get_rendezvous_servers() -> Vec<String> {
        ...
        return RENDEZVOUS_SERVERS.iter().map(|x| x.trim().to_string()).collect();
    }
